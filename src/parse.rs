...
fn get_number_indices_single(filename: &str) -> NumberIndices {
    ...
    NumberIndices::from(cap.start() as u32, cap.end() as u32)
}

// 'a: lifetime parameter, see https://users.rust-lang.org/t/returning-values-borrowed-from-multiple-places/1350
pub fn get_numbers<'a>(filenames: &HashMap<&'a String, NumberIndices>) -> HashMap<&'a String, u32> {
    let mut map= HashMap::new();
...
fn get_number(filename: &str, indices: &NumberIndices) -> u32 {
